import SectionSvg from '../assets/icons/sectionSvg'
...
const Section = ({ className , id , crosses ,crossesOffset , customPaddings ,children }) => {
  ...
  return (
    ...
    ${crosses? 'lg:py-32 xl:py-40 ' : '' } ${className || "" }`}`}>
      ...
      {children}
      <div className='hidden absolute top-0 left-5 h-full w-0.25 
       pointer-events-none md:block lg:left-7.5 xl:left-10'
      /> 
      <div className='hidden absolute top-0 right-5 h-full w-0.25 
